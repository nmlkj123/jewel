...
<body>
	<form id="frm" name="frm" action="<c:url value='/adminNoticeWrite'/>" method="post">
		...
		<table class="board_view">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text"  id="NT_TITLE" name="NT_TITLE" ></input></td>
				</tr>
				<tr>
					<th scope="row">공지 유형</th>
					<td><input type="text" id="NT_TYPE" name="NT_TYPE"></input></td>
				</tr>
				
				<tr>
					<th scope="row">공지 내용</th>
					<td><textarea rows="10" cols="40" id="NT_CONTENT" name="NT_CONTENT"></textarea></td>
				</tr>
			</tbody>
		</table>
	
	<button type="button" onclick="fsubmit();">공지 등록</button>
