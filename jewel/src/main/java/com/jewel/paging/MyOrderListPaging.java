...
public class MyOrderListPaging {
	...
	public void makePagingHTML() {
		...
		for(int i=startPage; i<=endPage; i++) {
			if(i==currentPage) {
				pagingHTML.append("<li class='page-item active'><a class='page-link' href='"+path+"/myPage/myOrderList?pg="+i+"'>"+i+"</a></li>");
			}else {
				pagingHTML.append("<li class='page-item'><a class='page-link' href='"+path+"/myPage/myOrderList?pg="+i+"'>"+i+"</a></li>");
			}
		...
		if(endPage<totalP) {
			pagingHTML.append("<li class='page-item'><a class='page-link' href='"+path+"/myPage/myOrderList?pg="+(endPage+1)+"'>다음</a></li>");
		}
