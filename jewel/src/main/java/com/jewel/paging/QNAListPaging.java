...
public class QNAListPaging {
	...
	public void makePagingHTML() {
		...
		if(startPage>pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' onclick='qnaPage("+(startPage-1)+")'>이전</a></li>");
		...
		if(endPage<totalP) {
			pagingHTML.append("<li class='page-item'><a class='page-link' onclick='qnaPage("+(endPage+1)+")'>다음</a></li>");
		}
